# Security Policy for Open-RAIC

Thank you for helping us keep Open-RAIC secure! We take the security of our platform, multi-agent engine, and users very seriously.

## Supported Versions

We currently provide security updates for the latest major release and the active `main` branch. Please ensure you are running the most recent version of Open-RAIC before submitting a report.
