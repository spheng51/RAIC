...
- `tests/server/production-milestone-smoke-script.test.ts` covers production milestone smoke skipping Discord readiness unless required and blocking when `RAIC_REQUIRED_PRODUCTION_FEATURES=discord` while Discord env is incomplete.
